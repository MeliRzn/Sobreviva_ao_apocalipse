...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/deividcomsono/Obsidian/main/init.luau"))()
...
local KillAuraTab = Window:Tab("⚔️ Kill Aura")
...
local collectedLabel = FarmTab:Label("📦 Collected: 0")
local backpackLabel = FarmTab:Label("🎒 Mochila: 0")
...
local rangeLabel = KillAuraTab:Label("📏 Range: 6 studs")
local swingLabel = KillAuraTab:Label("⏱️ Swing Delay: 0.5s")
